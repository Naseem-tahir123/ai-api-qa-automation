...
export const api = {
  ...
  report: () => pause({ total_tests_executed: 74, total_passed: 69, total_failed: 5, pass_rate_percentage: 93.2, coverage_percentage: 88, total_execution_time_ms: 2481, endpoint_details: demoEndpoints.map((ep, i) => ({ endpoint_id: ep.id, method: ep.method, path: ep.path, passed: 10 + (i % 3), failed: i % 3 === 0 ? 1 : 0 })) }),
}
